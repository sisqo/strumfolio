/**
 * The link a guest's device opens to follow a Sing Together broadcast.
 *
 ...
 * does once safely on the client. Kept out of `singAlong/session.ts` because that module is

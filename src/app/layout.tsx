...
export const metadata: Metadata = {
  ...
  /* No `title` or `description` here: Next merges a page's metadata over this, and a page that
     sets only `openGraph` — the tools, the blog, the changelog — inherited «Strumfolio» and the
     payoff on X under its own og:title. Left out, X falls back to each page's og:* tags. */
  twitter: {
